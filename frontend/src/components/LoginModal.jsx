...
function LoginModal({ isOpen, onClose }) {
    ...
    // If already logged in, close modal immediately
    useEffect(() => {
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-2.5 px-4 bg-accent-orange hover:bg-accent-orange/90 text-black font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-accent-orange/60 focus:ring-offset-2 focus:ring-offset-secondary disabled:opacity-60"
                    >
